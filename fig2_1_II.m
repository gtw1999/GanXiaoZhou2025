...
spi = subs(sp,[alpha,beta,gamma,d],num)
...
E1 = spi(5,:);
E2 = spi(6,:);
L = [linspace(E1(1),E2(1),100);linspace(E1(2),E2(2),100);linspace(E1(3),E2(3),100)]';
...
text('Interpreter','latex','String','$E_1$','Position',[E1(1),E1(2),E1(3)-0.1],'FontSize',15);
text('Interpreter','latex','String','$E_2$','Position',[E2(1),E2(2),E2(3)+0.1],'FontSize',15);
...
for i=1:10:100
plot3(L(i,1),L(i,2),L(i,3),'o','markerSize',5,'MarkerFaceColor','k','MarkerEdgeColor','k')
end
plot3(L(100,1),L(100,2),L(100,3),'o','markerSize',5,'MarkerFaceColor','k','MarkerEdgeColor','k')
plot3(L(:,1),L(:,2),L(:,3),'k--','LineWidth',1.2)
...
hold off
ax=gca
exportgraphics(ax, 'fig0_2.png', 'Resolution', 300);
